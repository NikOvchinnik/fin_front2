...
import style from './CurrenciesAnalyticPage.module.css';
import { Notify } from 'notiflix';
import Loader from '../../../components/Loader/Loader';
import { getAnalyticsCurrencies } from '../../../helpers/axios/analytic';
...
const CurrenciesAnalyticPage = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      setLoading(true);
      const statistics = await getAnalyticsCurrencies({
  ...
  const sortedData = (() => {
    ...
    const dataWithoutTotal = statisticsRows.filter(
      row => row.currency_plain !== 'Total'
    );

    const totalRow = statisticsRows.find(row => row.currency_plain === 'Total');
...
export default CurrenciesAnalyticPage;
